...
import { Board, MoveTo, Monopoly } from 'phaser3-rex-plugins/plugins/board-components.js';
...
export default class extends Phaser.GameObjects.Image implements IChessA {
  ...
  constructor(board, {
    ...
    super(scene, startPoint.x, startPoint.y, 'avatar');
    ...
    const chessData = GetChessData(this);
    chessData.setBoard(board);
    this.rexChess = chessData;
    // add behaviors        
